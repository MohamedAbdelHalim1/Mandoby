                    ...
                    <div class="container text-center mt-5">
                        <div class="row justify-content-center">
                            <div class="col-xl-3 col-lg-3 mb-3">
                                ...
                                <img src="<?php echo e(asset('storage/' . $university->photo)); ?>"
                                                        alt="<?php echo e($university->name); ?>"
                                                        style="width: 68px; height: 41px;">                                    <div class="card-body">
                                        <h2 class="text-end fs-6 fw-bolder mb-3"><?php echo e($university->name); ?></h2>
...
</html><?php /**PATH E:\mandoby\resources\views/university-details.blade.php ENDPATH**/ ?>
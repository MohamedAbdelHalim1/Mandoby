                    ...
                    <div class="container mt-5">
                        <div class="row">
                            <div>
                                ...
                                <form id="nationalityForm" action="<?php echo e(route('nationality.store')); ?>" method="POST" enctype="multipart/form-data">
                                     <?php echo csrf_field(); ?>
                                    <!-- Modal -->
                                ...
                                <table class="table table align-middle">
                                    ...
                                    <?php $__currentLoopData = $nationalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nationality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($nationality->name); ?></td>
                                            <td>
                                            <?php if($nationality->photo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $nationality->photo)); ?>"
                                                        alt="<?php echo e($nationality->name); ?> Photo"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <div class="ms-2">
                                                        <button type="button" class="btn text-white" data-nationality-id="<?php echo e($nationality->id); ?>"
                                                            style="background-color: #1C7A36;">تعديل</button>
                                                    </div>
                                                    <div>
                                                        <button type="button" class="btn text-white" onclick="deleteNationality(<?php echo e($nationality->id); ?>)"
...
</html><?php /**PATH E:\mandoby\resources\views/nationality.blade.php ENDPATH**/ ?>
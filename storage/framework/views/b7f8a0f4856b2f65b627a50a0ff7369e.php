                    ...
                    <div class="container mt-5">
                        <div class="row">
                            <div>
                                ...
                                <form id="basicServiceForm" action="<?php echo e(route('basic.service.store')); ?>" method="POST" enctype="multipart/form-data">
                                     <?php echo csrf_field(); ?>
                                <!-- Modal -->
                                ...
                                <table class="table table align-middle">
                                    ...
                                    <?php $__currentLoopData = $basicServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $basicService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($basicService->name); ?></td>
                                            <td>
                                            <?php if($basicService->photo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $basicService->photo)); ?>"
                                                        alt="<?php echo e($basicService->name); ?> Photo"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        <button type="button" class="btn text-white" onclick="deleteBasicService(<?php echo e($basicService->id); ?>)"
...
</html><?php /**PATH E:\mandoby\resources\views/basic_services.blade.php ENDPATH**/ ?>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                 ...
                                 <nav class="menu">
                                    <ul>
                                        <li class="mb-4">
                                            <a href="<?php echo e(route('nationalities.index')); ?>" class="main-nav">
                                    ...
                                    <table class="table table align-middle">
                                        ...
                                        <?php $__currentLoopData = $nationalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nationality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($nationality->members->count()); ?></td>
                                                <td>
                                                <?php if($nationality->photo): ?>
                                                    <img src="<?php echo e(asset('storage/Photos' . $nationality->photo)); ?>"
...
</html><?php /**PATH E:\mandoby\resources\views/home.blade.php ENDPATH**/ ?>
                                        ...
                                        <li class="mb-4">
                                            ...
                                            <nav id="menu-ser-small" class="menu-ser-small mt-3">
                                                <ul class="me-3">
                                                    ...
                                                    <li class="mb-4">
                                                        <a href="sub-service.html" style="color: #22219A; font-weight: bolder; font-size: 14px;">
                            ...
                            <ul>
                                ...
                                <li class="mb-4">
                                    ...
                                    <nav class="mt-3">
                                        <ul class="me-3">
                                            <li class="mb-2">
                                                <a href="main-service.html" style="font-size: 14px;">
                                                    <i class="fa-solid fa-square ms-2"></i>خدمات رئيسية
                                                </a>
                                            </li>
                                            <li class="mb-4">
                    ...
                    <div class="container mt-5">
                        <div class="row">
                            <div>
                                ...
                                <form id="subServiceForm" action="<?php echo e(route('sub.service.store')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <!-- Modal -->
                                                        ...
                                                        <span id="nameError" class="text-danger"></span>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select id="disabledSelect" class="form-select" name="basic_service">
                                                                    ...
                                                                    <?php $__currentLoopData = $basicServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $basicService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($basicService->id); ?>"><?php echo e($basicService->name); ?></option>
                                ...
                                <table class="table table align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($subService->BasicService->name); ?></td>
                                            <td>
                                            <?php if($subService->photo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $subService->photo)); ?>"
                                                        alt="<?php echo e($subService->name); ?> Photo"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        <button type="button" class="btn text-white" onclick="deleteSubService(<?php echo e($subService->id); ?>)"
...
<?php /**PATH E:\mandoby\resources\views/sub_services.blade.php ENDPATH**/ ?>
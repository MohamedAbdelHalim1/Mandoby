                            ...
                            <div class="offcanvas-body">
                                 ...
                                 <nav class="menu">
                                    ...
                                    <i class="fa-solid fa-building-columns ms-3 fw-semibold"></i>جامعات
                                        ...
                                        <li class="mb-4">
                                            <a href="{{route('user.index')}}" class="main-nav" style="  color: #3736AF; font-weight: bolder;">
                ...
                <div class="col-xl-10 col-lg-9 col-md-3 mb-5">
                    <div class="row">
                        <div class="col-12 p-3" style="background-color: white;">
                            <h2 class="fw-light fs-4">المستخدمين</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" style="color: #22219A;" aria-current="page"> اضافة مستخدم
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-end ms-xl-5 ms-lg-5 ms-md-5">
                                    <button type="button" class="btn button-modal2 p-3" data-bs-toggle="modal"
                                        ...
                                        <i class="fa-solid fa-plus ms-2"></i>أضافة مستخدم جديد
                                    </button>
                                </div>
                                                        ...
                                                        <div class="form col-xl-12 col-lg-12">
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label text-dark">   الاسم
                                                                     </label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label text-dark">  الايميل 
                                                                     </label>
                                                                <input type="text" class="form-control"
                                                                    placeholder=" اكتب الايميل" name="email" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label text-dark">  دور المستخدم
                                                                     </label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="اكتب الدور الذى سيقوم به المستخدم" name="role" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <table class="table table align-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="background-color: #E9E9F2;"> الايميل الاليكتروني</th>
                                            <th scope="col" style="background-color: #E9E9F2;">دور المستخدم</th>
                                        </tr>
                                    </thead>
                                    <tbody>

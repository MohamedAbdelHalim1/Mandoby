...
<body>
                            ...
                            <div class="offcanvas-body">
                                 ...
                                 <nav class="menu">
                                    ...
                                    <i class="fa-solid fa-building-columns ms-3 fw-semibold"></i>جامعات
                                        ...
                                        <li class="mb-4">
                                            <a href="{{route('news.index')}}" class="main-nav" style="  color: #3736AF; font-weight: bolder;">
                ...
                <div class="col-xl-10 col-lg-9 col-md-3 mb-5">
                    <div class="row">
                        <div class="col-12 p-3" style="background-color: white;">
                            <h2 class="fw-light fs-4">الاخبار</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" style="color: #22219A;" aria-current="page">اضافة خبر
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-end ms-xl-5 ms-lg-5 ms-md-5">
                                    <button type="button" class="btn button-modal2 p-3" data-bs-toggle="modal"
                                        ...
                                        <i class="fa-solid fa-plus ms-2"></i>أضافة خبر جديد
                                    </button>
                                </div>
                                                        ...
                                                        <div class="form col-xl-12 col-lg-12">
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label text-dark">عنوان الخبر
                                                                </label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="اكتب هنا اسم الخدمة" name="title" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label text-dark">
                                                                    اكتب تفاصيل الخبر</label>
                                                                <textarea class="form-control p-3"
                                                                    aria-label="With textarea"
                                                                    placeholder="اكتب هنا تفاصيل الخبر...." name="description" required></textarea>
                                                            </div>
                                                            <!-- Dropzone area -->
                                                            <div>
                                                                <label for="exampleInputEmail1"
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-3 col-lg-3 mb-3">
                                <div class="card" style="width: 100%;">
                                 @if ($news->photo)
                                                    <img src="{{ $news->photo }}" class="card-img-top"
                                                        alt="{{ $news->title }} Photo"
                                                        >
                                                @endif                    
                                        <div class="card-body">
                                        <h2 class="text-end fs-6 fw-bolder mb-2">{{$news->title}}</h2>
                                        <p class="mb-3" style="font-size: 10px!important;">
                                        {{$news->description}}
                                    </p>
                                        ...
                                        <div class="ms-2">
                                                        <button type="button" class="btn text-white button-modal2"
                                                            ...
                                                            style="background-color: #1C7A36;" onclick="openEditModal({{ $news->id }})">تعديل</button>
                                                    </div>
                                         <div>
                                         <button type="button" class="btn text-white" onclick="deleteNews({{ $news->id }})"
                            ...
                            <form id="editForm" action="{{ route('news.upload')  }}" method="POST" enctype="multipart/form-data">
                                     @csrf
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    ...
                                                                    اكتب تفاصيل الخبر</label>
                                                                <textarea class="form-control p-3"
                                                                    aria-label="With textarea" id="newsDescription"
                                                            ...
                                                            <div class="mt-2 d-flex justify-content-center" id="newsImagePreview" style="height:150px;"></div>
 ...
 function deleteNews(newsId) {
        ...
        if (confirm('هل انت واثق من مسح هذا الخبر؟')) {
    ...
    function openEditModal(newsId) {
        jQuery.ajax({
            url: '/news/' + newsId + '/edit', // Replace with your route for fetching nationality data
            type: 'GET',
            success: function(response) {
                ...
                if (response.photo) {
                    $('#newsImagePreview').html('<img src="' + response.photo + '" class="img-fluid">');
                } else {
                    $('#newsImagePreview').text('No image selected');
                }
    ...
    function updatenews() {
        ...
        $.ajax({
            url: '/news/update', // Replace with your route for updating
            type: 'POST',
            data: formData,
            success: function(response) {
